...
const en: Record<string, string> = {
  ...
  'phase.libraries': 'Downloading libraries',
  'phase.assets': 'Downloading game assets',
  'phase.java': 'Installing Java',
  'phase.forge': 'Installing Forge',
  // hero eyebrow
  ...
  'prof.skin.remove': 'Remove skin',
  'prof.skin.removeConfirm': 'Remove your uploaded skin and go back to the default skin?',
  'prof.skin.removed': 'Skin removed — back to default.',
  // sidebar
  ...
  // tasks / quests panel
  'tasks.title': 'Tasks',
  'tasks.seeMore': 'See more',
  'tasks.showLess': 'Show less',
  'tasks.daily': 'Daily',
  'tasks.weekly': 'Weekly',
  'tasks.custom': 'Special',
...
const ka: Record<string, string> = {
  ...
  'phase.libraries': 'ბიბლიოთეკების ჩამოტვირთვა',
  'phase.assets': 'თამაშის რესურსების ჩამოტვირთვა',
  'phase.java': 'Java-ს დაყენება',
  'phase.forge': 'Forge-ის დაყენება',
  'hero.eyebrow.featured': 'მომავლის სერვერი',
  'hero.eyebrow.inDev': 'დამუშავების პროცესში',
  'hero.eyebrow.selected': 'არჩეული სერვერი',
  'group.fav': 'რჩეულები',
  'group.published': 'საჯარო',
  'group.featured': 'მომავლის',
  ...
  'prof.skin.remove': 'სკინის მოხსნა',
  'prof.skin.removeConfirm': 'მოვხსნა ატვირთული სკინი და დავბრუნდე ნაგულისხმევზე?',
  'prof.skin.removed': 'სკინი მოიხსნა — დაბრუნდა ნაგულისხმევი.',
  ...
  'tasks.seeMore': 'მეტის ნახვა',
  'tasks.showLess': 'ნაკლების ჩვენება',
  'tasks.daily': 'დღიური',
  'tasks.weekly': 'კვირეული',
  'tasks.custom': 'სპეციალური',
  'tasks.completed': 'დასრულდა',
